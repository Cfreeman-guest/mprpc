...
inline void LoginResponse::set_allocated_result(::mprpc::ResultCode* result) {
  ...
  if (result) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::mprpc::ResultCode>::GetOwningArena(result);
...
inline bool LoginResponse::sucess() const {
  // @@protoc_insertion_point(field_get:mprpc.LoginResponse.sucess)
...
inline void LoginResponse::set_sucess(bool value) {
  ...
  // @@protoc_insertion_point(field_set:mprpc.LoginResponse.sucess)
}
